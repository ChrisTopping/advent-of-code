...
@AdventOfCodeSolution(year = 2015, day = 10, part = 2,
        description = "Elves Look, Elves Say",
        link = "https://adventofcode.com/2015/day/10#part2",
        tags = "unsolved"
)
public class Day10Part2Solution2015 implements Solution<Integer> {

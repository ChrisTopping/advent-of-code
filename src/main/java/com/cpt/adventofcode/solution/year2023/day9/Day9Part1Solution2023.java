...
@AdventOfCodeSolution(year = 2023, day = 9, part = 1,
        description = "Mirage Maintenance",
        link = "https://adventofcode.com/2023/day/9",
        tags = ""
)
public class Day9Part1Solution2023 implements Solution<Long> {
    ...
    private long extrapolate(List<Long> sequence) {
        ...
        return extrapolate(differences(sequence)) + sequence.get(sequence.size() - 1);
    }

...
class Day7Part1Solution2015IntegrationTest extends BaseTest<Integer> {

    @Test
    @DisplayName("Given test input: should return 3176")
    void givenTestInput_ShouldReturn() {
        Day7Part1Solution2015 solution = new Day7Part1Solution2015();
        assertSolutionIsCorrect(solution, 3176);
    }
